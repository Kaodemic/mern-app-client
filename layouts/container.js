  ...
  return (
    <>
      <div className="container grid grid-cols-12 gap-3 px-3 mx-auto">
        <div className={'col-span-2 space-x-4 pt-4'}>
          <svg
        ...
        <div
          className={
            'col-span-12 md:col-span-9 lg:col-span-6 xl:col-span-7 pb-24 pt-2'
          }
        >
          {props.children}
        </div>
        <div
          className={
            'col-span-12 md:col-span-9 lg:col-span-6 xl:col-span-3 pt-2 space-y-3'
          }
        >
          <div className={'relative'}>
            <div
              className={'absolute h-full flex items-center px-4 left-0 z-10'}
            >
              <svg
            ...
            <input
              type="text"
              className={
                'relative bg-transparent outline-none border focus:border-green-700 px-12 py-3 focus:px-4 focus:bg-white z-20 duration-150 rounded-md w-full'
              }
