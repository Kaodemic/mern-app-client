...
describe("test function utils.js", () => {
  ...
  describe("toSlug", () => {
    it("toSlug without HTML", () => {
      const str = `(*) Cài đặt bộ lọc công ty để hạn chế nhận gợi ý các công việc liên quan`;
      const result = toSlug(str);
      expect(result).toMatch("cai-dat-bo-loc-cong-ty-de-han-che-nhan-goi-y-cac-cong-viec-lien-quan");
    });
